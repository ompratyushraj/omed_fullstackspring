...
const PharmaDescription = () => {
  return (
    <div className="container mt-5 mb-5">
      <header className="text-center mb-4">
        <h1 className="display-4 text-primary">- Stay Healthy with OMED -<br />Your trusted online and offline<br /> Pharmacy and Healthcare Care Taker</h1>
        <p className="lead mt-4">We Bring <strong className='fw-bold'><i>Care</i></strong> to <strong className='fw-bold'>Your Precious</strong> <i><strong  className='fw-bold'>Health</strong></i>.</p>
      </header>
      ...
      <section className="mb-3">
        <h2 className="h2 text-secondary">The Feathers in Our Cap</h2>
        <p className="fs-5">
           OMED has been honored with awards like the BML Munjal Award for 'Business Excellence through Learning and Development', Best Online Pharmacy in India Award, and many more. In 2019 alone, we received three awards including the BMW Simply Unstoppable Award.
        </p>
      </section>
...
export default PharmaDescription;
