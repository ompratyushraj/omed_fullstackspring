...
const Devices = () => {
  ...
  const getArrowColor = () => {
    return {
      backgroundColor: mode === "dark" ? "#FFFFFF" : "#000000", // Change arrow background based on mode
      color: mode === "dark" ? "#000000" : "#FFFFFF",           // Change arrow color based on mode
    };
  };
  ...
  return (
    <div className="container my-1">
      <p className="ms-5 fw-bold fs-4 mt-4" style={textStyle}>Devices</p>
