...
import FC1 from "../../../assets/images/Banners/ProductSlickers02.png"; // Image for the carousel

const MedicatedCreams = () => {
  ...
  return (
    <div className="container my-1">
      <p className="ms-5 fw-bold fs-4 mt-4" style={textStyle}>Medicated Creams</p>
...
export default MedicatedCreams;
